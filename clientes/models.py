...
from profissionais.models import Agenda
...
class Agendamento(models.Model):
    agenda =  OneToOneField(Agenda, on_delete=models.CASCADE, related_name='agendamento')
    cliente = ForeignKey(Cliente, on_delete=models.CASCADE, related_name='agendamento')
